...
- [ ] Newer `main` Counter History and context-parser work is preserved and migrated without task-ID collisions.
...
| Newer main work preserved | explicit reconciliation of Counter History + context parser | In progress |
