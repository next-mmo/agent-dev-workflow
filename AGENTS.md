...
- Delivery and risk gates: [`.agents/docs/agent-workflow.md`](.agents/docs/agent-workflow.md).
- Architecture/ownership map: [`.agents/docs/architecture.md`](.agents/docs/architecture.md).
