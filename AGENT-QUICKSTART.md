...
Detailed policy lives in [`.agents/docs/agent-workflow.md`](.agents/docs/agent-workflow.md), and command routing lives in [`.agents/skills/agent-workflow-scrum/references/commands.md`](.agents/skills/agent-workflow-scrum/references/commands.md).
